...
export const ConfiguracinProceso = () => {
  return (
    <div className="configuracin-proceso" data-model-id="36:108">
            ...
            <div className="container-4">
              <div className="container-5">
                <div className="label-margin">
                  <div className="div-2">
                    <div className="text-wrapper">Nombre de la planta</div>
                  </div>
                </div>
              ...
              <div className="div-2">
                <div className="div-2">
                  <div className="text-wrapper">Duración del proceso</div>
                </div>
                ...
                <div className="container-7">
                  ...
                  <div className="container-9">
                    ...
                    <button className="div-wrapper">
                      <div className="hours-option-2">12h</div>
                    </button>
                    <button className="div-wrapper">
                      <div className="hours-option-2">24h</div>
                    </button>
                    <button className="div-wrapper">
                      <div className="hours-option-2">48h</div>
                    </button>
                  </div>
